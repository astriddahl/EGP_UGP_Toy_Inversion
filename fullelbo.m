function [fullF]=fullelbo(hparams,M,C,phi_in,Y,dims,nlf,LAMBDA,theta)
% Calculation of Evidence Lower Bound (nelbo) - full expression
% full expression for elbo = eqn(8)-eqn(5)
% A Dahl August 2015
